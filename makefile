...
# Tool invocations
BLE_p2pServer.elf BLE_p2pServer.map: $(OBJS) $(USER_OBJS) /Users/libbyglieden/STM32CubeIDE/workspace_1.19.0/BLE_p2pServer/STM32CubeIDE/STM32WB5MMGHX_FLASH.ld makefile objects.list $(OPTIONAL_TOOL_DEPS)
	arm-none-eabi-gcc -o "BLE_p2pServer.elf" @"objects.list" $(USER_OBJS) $(LIBS) -mcpu=cortex-m4 -T"/Users/libbyglieden/STM32CubeIDE/workspace_1.19.0/BLE_p2pServer/STM32CubeIDE/STM32WB5MMGHX_FLASH.ld" --specs=nosys.specs -Wl,-Map="BLE_p2pServer.map" -Wl,--gc-sections -static --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -u _printf_float -Wl,--start-group -lc -lm -Wl,--end-group
